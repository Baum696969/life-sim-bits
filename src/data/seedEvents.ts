...
export const seedEvents: GameEvent[] = [
  ...
  // === GLÜCKS-EVENTS (Luck-based) ===
  {
    id: createId(),
    title: 'Geld auf der Straße',
    text: 'Du gehst die Straße entlang und siehst etwas auf dem Boden glitzern...',
    minAge: 6,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 1.5,
    tags: ['luck', 'money', 'random'],
    options: [
      opt('Aufheben', { moneyDelta: 50, luckDelta: 3 }, 'Es ist ein 50€ Schein! Glückstag!'),
      opt('Liegen lassen', { luckDelta: -1 }, 'Du gehst vorbei... war das etwa Geld?'),
    ],
  },
  {
    id: createId(),
    title: 'Verlorene Brieftasche',
    text: 'Du findest eine Brieftasche mit €200 darin. Ein Ausweis ist auch dabei.',
    minAge: 10,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 1.0,
    tags: ['luck', 'money', 'moral'],
    options: [
      opt('Beim Besitzer abgeben', { luckDelta: 15, moneyDelta: 30 }, 'Der Besitzer ist so dankbar, dass er dir €30 Finderlohn gibt! Gutes Karma!'),
      opt('Geld behalten', { moneyDelta: 200, luckDelta: -10 }, 'Du nimmst das Geld... aber du fühlst dich nicht gut dabei.'),
      opt('Zur Polizei bringen', { luckDelta: 8 }, 'Du gibst sie ab. Falls niemand sie abholt, bekommst du sie zurück!'),
    ],
  },
  {
    id: createId(),
    title: 'Rubbellos Gewinn',
    text: 'Du kaufst aus einer Laune heraus ein Rubbellos am Kiosk.',
    minAge: 18,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 1.2,
    tags: ['luck', 'gambling', 'money'],
    options: [
      opt('Rubbeln', { moneyDelta: 100, luckDelta: 5 }, 'Drei gleiche Symbole! Du gewinnst €100!'),
      opt('An jemand anderen verschenken', { luckDelta: 8 }, 'Die Person gewinnt €500 und ist super dankbar!'),
    ],
  },
  {
    id: createId(),
    title: 'Vierblättriges Kleeblatt',
    text: 'Im Park entdeckst du ein vierblättriges Kleeblatt!',
    minAge: 3,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 0.8,
    tags: ['luck', 'nature'],
    options: [
      opt('Aufbewahren', { luckDelta: 20 }, 'Du fühlst dich plötzlich viel glücklicher! 🍀'),
      opt('Verschenken', { luckDelta: 10, looksDelta: 2 }, 'Du schenkst es jemandem. Die Person strahlt!'),
      opt('Ignorieren', { luckDelta: 0 }, 'Du gehst weiter. War es echt vierblättrig?'),
    ],
  },
  {
    id: createId(),
    title: 'Gratisessen',
    text: 'Im Restaurant sagt der Kellner, dein Essen geht aufs Haus - du bist der 1000. Kunde!',
    minAge: 10,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 0.7,
    tags: ['luck', 'food', 'free'],
    options: [
      opt('Freuen und genießen', { luckDelta: 8, healthDelta: 3, moneyDelta: 30 }, 'Was für ein Glück! Leckeres Essen umsonst!'),
      opt('Extra Trinkgeld geben', { luckDelta: 12, moneyDelta: -10 }, 'Du gibst trotzdem Trinkgeld. Der Kellner ist beeindruckt!'),
    ],
  },
  {
    id: createId(),
    title: 'Parkplatz direkt am Eingang',
    text: 'Du findest sofort den perfekten Parkplatz direkt vor dem Geschäft!',
    minAge: 18,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 1.0,
    tags: ['luck', 'daily'],
    options: [
      opt('Nice!', { luckDelta: 3, healthDelta: 1 }, 'Kleines Glück, aber es macht den Tag besser!'),
    ],
  },
  {
    id: createId(),
    title: 'Regenbogen',
    text: 'Nach einem Regenschauer siehst du einen wunderschönen doppelten Regenbogen!',
    minAge: 0,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 0.6,
    tags: ['luck', 'nature', 'beautiful'],
    options: [
      opt('Foto machen', { luckDelta: 5, looksDelta: 1 }, 'Ein tolles Foto für die Erinnerung! 🌈'),
      opt('Einfach genießen', { luckDelta: 8, healthDelta: 2 }, 'Du stehst da und bewunderst die Natur.'),
    ],
  },
  {
    id: createId(),
    title: 'Alte Münze gefunden',
    text: 'Beim Graben im Garten findest du eine alte, seltene Münze!',
    minAge: 8,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 0.5,
    ...
    options: [
      opt('Zum Händler bringen', { moneyDelta: 500, luckDelta: 5 }, 'Die Münze ist €500 wert! Was für ein Fund!'),
      opt('Als Glücksbringer behalten', { luckDelta: 15 }, 'Du trägst sie immer bei dir. Sie bringt dir Glück!'),
      opt('Ignorieren', { luckDelta: -3 }, 'Du wirfst sie weg... war das etwa wertvoll?'),
    ],
  },
  {
    id: createId(),
    title: 'Zug verpasst - Glück im Unglück',
    text: 'Du verpasst deinen Zug, aber erfährst später, dass er eine Panne hatte!',
    minAge: 14,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 0.8,
    tags: ['luck', 'travel'],
    options: [
      opt('Erleichtert sein', { luckDelta: 10, healthDelta: 2 }, 'Puh! Das hätte 3 Stunden Verspätung bedeutet!'),
      opt('Den nächsten nehmen', { luckDelta: 5 }, 'Du nimmst den nächsten und kommst entspannt an.'),
    ],
  },
  {
    id: createId(),
    title: 'Gewinnspiel gewonnen',
    text: 'Du bekommst einen Anruf: Du hast bei einem Gewinnspiel gewonnen, an das du dich kaum erinnerst!',
    minAge: 18,
    maxAge: 100,
    category: 'random' as EventCategory,
    weight: 0.6,
    tags: ['luck', 'money', 'prize'],
    options: [
      opt('Preis abholen', { moneyDelta: 300, luckDelta: 8 }, 'Du gewinnst einen Gutschein im Wert von €300!'),
      opt('Klingt nach Betrug...', { luckDelta: 2 }, 'Du lehnst ab. Aber es war echt... naja, lieber vorsichtig.'),
    ],
  },

  // === FREUNDE FINDEN EVENT (2 Ausgänge) ===
  {
    id: createId(),
    title: 'Neue Bekanntschaft',
    text: 'Du triffst jemanden Interessantes bei einer Veranstaltung. Ihr unterhaltet euch gut...',
    minAge: 6,
    maxAge: 70,
    category: 'social' as EventCategory,
    weight: 2.0,
    ...
    options: [
      opt('Nummer austauschen', { luckDelta: 8 }, 'Ihr tauscht Nummern aus und werdet gute Freunde! 👥 [+1 Freund]'),
      opt('Nett plaudern und gehen', { luckDelta: -2 }, 'War nett, aber ihr seht euch nie wieder.'),
      opt('Zu schüchtern', { luckDelta: -5, healthDelta: -2 }, 'Du traust dich nicht. Schade...'),
    ],
  },
  {
    id: createId(),
    title: 'Klassenkamerad',
    text: 'Ein Klassenkamerad fragt, ob ihr zusammen Hausaufgaben machen wollt.',
    minAge: 6,
    maxAge: 18,
    category: 'social' as EventCategory,
    weight: 1.8,
    tags: ['social', 'friends', 'school'],
    options: [
      opt('Ja, gerne!', { luckDelta: 10, iqDelta: 2 }, 'Ihr lernt zusammen und werdet beste Freunde! 📚 [+1 Freund]'),
      opt('Nein, alleine lernen', { iqDelta: 1, luckDelta: -3 }, 'Du lernst alleine. Effektiv, aber einsam.'),
    ],
  },
  {
    id: createId(),
    title: 'Nachbar',
    text: 'Dein neuer Nachbar klingelt und stellt sich vor. Er scheint nett zu sein.',
    minAge: 18,
    maxAge: 80,
    category: 'social' as EventCategory,
    weight: 1.5,
    tags: ['social', 'friends', 'neighbor'],
    options: [
      opt('Zum Kaffee einladen', { luckDelta: 12, moneyDelta: -5 }, 'Ihr versteht euch super und werdet Freunde! ☕ [+1 Freund]'),
      opt('Kurz grüßen', { luckDelta: 0 }, 'Netter Smalltalk, aber keine Freundschaft.'),
      opt('Tür nicht öffnen', { luckDelta: -5 }, 'Du ignorierst das Klingeln. Komisch...'),
    ],
  },
  {
    id: createId(),
    title: 'Hobby-Gruppe',
    text: 'Du entdeckst eine lokale Gruppe für dein Hobby und überlegst beizutreten.',
    minAge: 12,
    maxAge: 70,
    category: 'social' as EventCategory,
    weight: 1.6,
