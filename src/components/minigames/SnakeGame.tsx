...
const SnakeGame = ({ onComplete }: SnakeGameProps) => {
  ...
  }, [gameState, endGame, generateFood]);
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <h2 className="font-display text-2xl text-primary">Snake</h2>
      ...
      <div className="relative">
        ...
        {gameState === 'ready' && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-background/80 rounded-lg">
            <p className="text-muted-foreground mb-4">Pfeiltasten oder WASD zum Steuern</p>
        ...
        {gameState === 'gameover' && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-background/80 rounded-lg">
            ...
            <p className="text-primary text-xl mb-4">Äpfel: {score}</p>
      ...
      <div className="text-center">
        <p className="text-2xl font-display text-primary">Äpfel: {score}</p>
        <p className="text-sm text-muted-foreground">€15 pro Apfel</p>
      </div>
    </div>
  );
};
